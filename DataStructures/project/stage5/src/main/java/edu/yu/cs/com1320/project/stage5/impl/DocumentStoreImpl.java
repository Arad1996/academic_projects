...
public class DocumentStoreImpl implements DocumentStore {
    ...
    public int putDocument(InputStream input, URI uri, DocumentStore.DocumentFormat format) throws IOException {
        ...
        // This is a delete
        if (input == null) {
            Document result = removeDocument(uri);
        ...
        Document result = btree.put(uri, document);
        ...
        if (result != null) {
            ...
            command = new GenericCommand<>(uri, uri_ -> {
                ...
                heap.insert(result);
                return btree.put(uri_, result) != null;
            });
        } else {
    ...
    private Document removeDocument(URI uri) {
    ...
    private Set<URI> deleteDocuments(Set<Document> documents) {
        ...
        for (Document doc : documents) {
            ...
            Document r = btree.put(doc.getKey(), null);
            ...
            GenericCommand<Document> command = new GenericCommand<>(doc, doc_ -> {
                ...
                return btree.put(doc_.getKey(), r) != null;
            });
